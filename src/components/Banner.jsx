...
const Banner = () => {
    return (
        <div>
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row md:gap-8 my-10'>
                <div className='w-full md:w-1/2 order-2 md:order-1 mt-12 md:mt-32'>
                    <div className='space-y-8'>
                        ...
                        <p className='text-xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore, deleniti similique nisi officia eveniet rerum expedita dicta perferendis dolore distinctio ea exercitationem vero alias possimus nemo quod nesciunt? A, sapiente.</p>
                        <label className="input input-bordered flex items-center gap-2 dark:bg-slate-900 dark:text-white dark:border-[2px] dark:border-white">
                        <svg
